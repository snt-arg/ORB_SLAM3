...
# Monocular Examples
# echo "Launching VH01
# ./Examples/Monocular-Inertial/mono_inertial_toa_euroc ./Vocabulary/ORBvoc.txt ./Examples/Monocular-Inertial/EuRoC.yaml "$pathDatasetEuroc"/V101 ./Examples/Monocular/EuRoC_TimeStamps/MH01.txt dataset-V101_monoMonocular
